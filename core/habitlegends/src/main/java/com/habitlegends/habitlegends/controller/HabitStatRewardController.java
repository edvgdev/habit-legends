...
public class HabitStatRewardController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<HabitStatRewardDTO> getHabitStatRewardById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<HabitStatRewardDTO> updateHabitStatReward(@PathVariable Long id,
            @RequestBody HabitStatRewardDTO habitStatRewardDTO) {
        return ResponseEntity.ok(habitStatRewardService.updateHabitStatReward(id, habitStatRewardDTO));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteHabitStatReward(@PathVariable Long id) {
