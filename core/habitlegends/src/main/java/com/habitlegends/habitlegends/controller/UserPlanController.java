...
public class UserPlanController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<UserPlanDTO> getUserPlanById(@PathVariable Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserPlanDTO> updateUserPlan(@PathVariable Integer id, @RequestBody UserPlanDTO userPlanDTO) {
        return ResponseEntity.ok(userPlanService.updateUserPlan(id, userPlanDTO));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteUserPlan(@PathVariable Integer id) {
