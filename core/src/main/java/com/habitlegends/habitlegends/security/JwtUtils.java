package com.habitlegends.habitlegends.security;
...
public class JwtUtils {
    ...
    public JwtUtils(@Value("${jwt.secret}") String SECRET_STRING) {
    ...
    public String generateRefreshToken(HashMap<String, Object> claims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .subject(userDetails.getUsername())
                .issuedAt(new Date(System.currentTimeMillis()))
                .expiration(new Date(System.currentTimeMillis() + +1000 * 60 * 60 * 24 * 7)) // 7days
                .signWith(key)
                .compact();
    }
