...
public class StatController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<StatDTO> getStatById(@PathVariable("id") Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<StatDTO> updateStat(@PathVariable("id") Integer id, @RequestBody StatDTO statDTO) {
        return ResponseEntity.ok(statService.updateStat(id, statDTO));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteStat(@PathVariable("id") Integer id) {
