...
public class RankController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RankDTO> getRankById(@PathVariable("id") Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RankDTO> updateRank(@PathVariable("id") Integer id, @RequestBody RankDTO rankDTO) {
        return ResponseEntity.ok(rankService.updateRank(id, rankDTO));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteRank(@PathVariable("id") Integer id) {
