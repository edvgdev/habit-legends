...
public class QuestDTO {
    ...
    public QuestDTO(Long id, String name, String description, Integer categoryId, Integer baseExpReward,
            String imageLink, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
